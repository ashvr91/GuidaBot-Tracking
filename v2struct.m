%% v2struct.m
% v2struct Pack/Unpack Variables to/from a scalar structure. Open source
% code obtained from the following link. Makes it easy to send/receive many
% variables between functions by using a custom structure data type.

% Source: https://www.mathworks.com/matlabcentral/fileexchange/31532-pack---unpack-variables-to---from-structures-with-enhanced-functionality/content/html/v2struct.html
